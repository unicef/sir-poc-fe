...
import { reviewIncidentStaffWellbeing } from '../../../actions/incidents.js';
 ...
 *
 */
class ReviewWellbeingButton extends ButtonsBaseClass {
  static get template() {
    return html`
  ...
  static get is() {
    return 'review-wellbeing-button';
  }
  ...
  async markAsReviewed() {
    let successfull = await this.store.dispatch(reviewIncidentStaffWellbeing(this.incident));
...
window.customElements.define(ReviewWellbeingButton.is, ReviewWellbeingButton);
