...
export class HistoryNavigationLinks extends HistoryHelpers(PolymerElement) {
  ...
  static get template() {
    return html`
      ...
      <a href="events/history/[[workingItem.data.id]]/list" title="Go to changes list">
      ...
      <a href="events/history/[[workingItem.data.id]]/view/[[workingItem.id]]"
           hidden$="[[pageIs('view')]]"
           title="View entire event at this version">
        <paper-button raised class="white-bg smaller">
          <iron-icon icon="assignment"></iron-icon>
           Event at this revision
        </paper-button>
      </a>

      <a href="events/history/[[workingItem.data.id]]/diff/[[workingItem.id]]"
