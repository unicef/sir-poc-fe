...
export class EventDiff extends DateMixin(HistoryHelpers(connect(store)(PolymerElement))) {
  static get template() {
    return html`
  ...
  getReadableValue(key, value) {
    ...
    switch (key) {
      ...
      case 'event_category':
        return this.getNameFromId(value, 'eventCategories');
...
window.customElements.define(EventDiff.is, EventDiff);
